...
You can see example docs generated from recent recent Clojure and Clojure Contrib sources by opening @examples/index.html@ in your browser.
...
<pre><code>
cd clj-doc
clj bin/clojure_gen.clj /path/to/output
